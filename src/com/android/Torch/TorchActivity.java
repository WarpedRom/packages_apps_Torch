...
public class TorchActivity extends Activity implements SurfaceHolder.Callback {
    public static final String TAG = "TorchAct";
    public static final String TORCH_ON = "com.android.torch.INTENT_TORCH_ON";
    public static final String TORCH_OFF = "com.android.torch.INTENT_TORCH_OFF";
    public static final String TORCH_TOGGLE = "com.android.torch.INTENT_TORCH_TOGGLE";
